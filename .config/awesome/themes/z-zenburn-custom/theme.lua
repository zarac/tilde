-- z-zenburn-custom, awesome3 theme, modifications by Hannes L. (zarac)
...
--theme.font      = "DejaVuSerifCondensed 10"
-- SilkScreen font http://www.kottke.org/plus/type/silkscreen/
theme.font      = "slkscr 7"
